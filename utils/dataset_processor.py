...
if(len(sys.argv)!=5):
    print("dataset_processor usage: Please provide the filepaths. Call this script as python dataset_processor.py <story-filapath> <senetence-filepath> <skeleton-filepath> <ordered_dataset_filepath>")
    sys.exit(1)
